...
public class LottoBaseTest {
     ...
     * percents will be checked. After that, test will check method with more
     * than one parameter. Test will also check if proper exceptions were thrown
     * where they should.
     *
    ...
    public void testDoNewRandomWinningSetsProcedure(int amount) throws NumberFormatException {
        ...
        try {
            ...
            testBase.clear();
            instance.DoNewRandomWinningSetsProcedure(amount, amount, amount);
            testBase = instance.getAllDatabaseElements();

            if (amount > 0) {
                expectedSize = (amount * 6) * 3;
            } else {
                expectedSize = 0;
            }
            assertEquals(expectedSize, testBase.size(), "Incorrect amount of numbers generated by method!");
     ...
     * of bot databases will be compared to make sure their size is equal.
     *
     * @param filename
